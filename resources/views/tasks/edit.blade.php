...
<div class="edit-wrapper">
    ...
    <div class="form-card">
        <div class="form-card-header">
            <span class="form-card-title">Edit Task</span>
        </div>
        <div class="form-card-body">
            <form action="{{ route('tasks.update', $task) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" rows="3" placeholder="Enter task description (optional)">{{ old('description', $task->description) }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="due_date" value="{{ old('due_date', $task->due_date->format('Y-m-d')) }}" min="{{ date('Y-m-d') }}">
                    @error('due_date')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
